/*
 * Implements the fm get routines used by the XView frame module.
 *
...
static KeySym frame_keycode_to_keysym(Display *dpy, KeyCode keycode, int index);

static KeySym
frame_keycode_to_keysym(dpy, keycode, index)
    Display *dpy;
    KeyCode keycode;
    int index;
{
...
int		remove;
{
     ...
     */
    keysymlist[0] = frame_keycode_to_keysym(dpy, keycode, 0);
     ...
     */
    keysymlist[1] = frame_keycode_to_keysym(dpy, keycode, 1);
